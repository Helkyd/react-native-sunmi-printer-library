...
import com.sunmiprinterlibrary.SunmiPrinterLibraryModule
...
class EmvUtil {
    ...
    fun initKey() {
        try {
            val mSecurityOptV2: SecurityOptV2 = SunmiPrinterLibraryModule.mSecurityOptV2!! //BaseApp.mSecurityOptV2!!
    ...
    fun initAidAndRid() {
        try {
            val mEMVOptV2: EMVOptV2 = SunmiPrinterLibraryModule.mEMVOptV2!! // BaseApp.mEMVOptV2!!
